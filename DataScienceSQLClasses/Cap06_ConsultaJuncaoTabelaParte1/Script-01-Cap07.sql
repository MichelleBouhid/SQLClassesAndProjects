...
-- Serial é um numero de auto incremento criado pelo proprio SGBD (Postgresql aqui)
-- Check - instrução DDL, cuidado pode prejudicar performance se a tabela recebe dados com mta frequencia
...
-- A FOREIGN KEY define a integ Referencial, que faz referencia a outra tabela
-- Só pode colocar um produto se o produto existir na tabela produtos, o mesmo com clientes, tem que existir na tabela clientes
-- Evita registro orfão
...
-- Criamos sem integridade para observar os problemas que podem ocorer
...
-- Pode cadastrar produtos null, id 44 que nao existe, tecnicamente está errado, não pode criar tabelas sem integridade referencial
